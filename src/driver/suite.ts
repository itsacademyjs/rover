...
class Suite extends EventEmitter {
     ...
     * @return {Suite}
     */
    static create = function (parent, title) {
     ...
     */
    beforeAll = function (title: (() => void) | string, fn?) {
        if (this.isPending()) {
            return this;
        }
     ...
     * @returns {Boolean}
     */
    filterOnly = function filterOnly() {
     ...
     * @param {Suite} suite
     */
    appendOnlySuite = function (suite) {
     ...
     * @private
     */
    cleanReferences = function cleanReferences() {
